...
{
    public class ActualizarServicioPromocionDto
    {
        ...
        [Required(ErrorMessage = "El IdPromocionAnterior es requerido")]
        [Range(1, int.MaxValue, ErrorMessage = "El IdPromocionAnterior debe ser mayor a 0")]
        public int IdPromocionAnterior { get; set; }
    }
}
